...
/* harmony default export */ var chatvue_type_script_lang_js_ = ({
  ...
  methods: {
    ...
    userAvatar(number, retina) {
      ...
      if (retina) {
        return __webpack_require__(609)("./avatar_" + avatar + "_sm@2x.png");
      } else {
        return __webpack_require__(610)("./avatar_" + avatar + "_sm.png");
      }
    },
