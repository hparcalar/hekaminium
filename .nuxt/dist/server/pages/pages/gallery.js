...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/vue-loader/lib/loaders/templateLoader.js??ref--6!./node_modules/vue-loader/lib??vue-loader-options!./pages/pages/gallery.vue?vue&type=template&id=1ab003a5&
  ...
  return _c('div', {
    ...
    return _vm._ssrNode("<div>", "</div>", [_c('ScCard', [_c('ScCardBody', {
      ...
      directives: [{
        name: "show",
        rawName: "v-show",
        value: _vm.rating[photo.id],
        expression: "rating[photo.id]"
      }],
      key: "rated",
      staticClass: "uk-display-block"
    }, [_c('i', {
...
// CONCATENATED MODULE: ./pages/pages/gallery.vue?vue&type=template&id=1ab003a5&
  ...
  computed: {
    photos() {
      ...
      ['ray-hennessy-763310-unsplash', 'daria-kopylova-766667-unsplash', 'casey-horner-768005-unsplash', 'urban-sanden-768851-unsplash', 'steve-roe-763192-unsplash', 'wynand-van-poortvliet-761831-unsplash', 'rodion-kutsaev-760882-unsplash', 'san-fermin-pamplona-navarra-768251-unsplash', 'shane-young-768821-unsplash', 'avantgarde-concept-763896-unsplash', 'eiliv-aceron-765897-unsplash', 'pietro-mattia-764559-unsplash', 'rachel-park-366508-unsplash', 'alex-guillaume-769172-unsplash', 'ciaran-o-brien-769402-unsplash', 'paula-brustur-766878-unsplash', 'briana-tozour-756151-unsplash'].forEach((k, index) => {
        ...
        photos.push({
          id: id,
          large: __webpack_require__(277)("./" + k + ".jpg"),
          small: __webpack_require__(438)("./" + k + "_md.jpg"),
          small2x: __webpack_require__(439)("./" + k + "_md@2x.jpg"),
          desc: sentence({
            words: 10
          }),
