          ...
          <div class="uk-margin-medium uk-margin-remove-left">
              ...
              <div class="uk-width-1-5@l">
                <div class="uk-button-group sc-padding-remove-left" style="height:34px;">
                  ...
                  <button v-show="selectedDemandDetail && selectedDemandDetail.id > 0" type="button"
                    @click="removeDemandDetail" class="sc-button sc-button-danger sc-button-small uk-width-expand"
                    style="height:34px;">
            ...
            <client-only>
              <!-- <Datatable
                            ...
                            ></Datatable> -->
              <br>
              <DataTable :value="details" editMode="cell" @cell-edit-complete="onCellEditComplete"
...
export default {
  ...
  created() {
    this.columns = [
      { field: 'lineNumber', header: 'Satır No' },
      { field: 'createdDate', header: 'Eklenme Tarihi' },
      { field: 'itemName', header: 'Stok Adı' },
      { field: 'itemExplanation', header: 'Stok Açıklaması' },
      { field: 'partNo', header: 'Parça Kodu' },
      { field: 'partDimensions', header: 'Boyutlar' },
      { field: 'quantity', header: 'Miktar' },
      { field: 'statusText', header: 'Durum' }
    ]; 
  },
  computed: {
    currentProjectName() {
