						...
						<ScCardBody>
							<div class="sc-timeline sc-timeline-center">
								<div v-for="item in timeline" :key="item.id" class="sc-timeline-item">
									...
									<div v-show="item.icon !== ''" class="sc-timeline-icon" :class="[item.color]">
						...
						<ScCardBody>
							<div class="sc-timeline sc-timeline-right">
								<div v-for="item in timeline" :key="item.id" class="sc-timeline-item">
									...
									<div v-show="item.icon !== ''" class="sc-timeline-icon">
										<i v-show="!item.iconAvatar" :class="['mdi', item.icon, item.iconColor]"></i>
										<ScAvatar v-show="item.iconAvatar" :avatar-id="item.iconAvatar"></ScAvatar>
									</div>
									<div :class="['sc-timeline-body', item.extraClass]">
										<h4 class="sc-timeline-header">
											{{ item.title | capitalize }}
