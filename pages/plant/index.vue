					...
					<form>
						<fieldset class="uk-fieldset uk-fieldset-alt md-bg-white sc-padding-medium">
							...
							<div class="uk-child-width-1-2@m uk-grid" data-uk-grid>
								<div>
									<ScInput v-model="formData.plantCode">
										<label>İşletme Kodu</label>
									</ScInput>
								</div>
								<div>
									<ScInput v-model="formData.plantName">
						...
						<div class="uk-margin-large-top">
							<button type="button" @click="onSubmit" v-show="hasViewAuth('FirmAndProjectCategories',1)"
                            ...
                            <button type="button" @click="onDelete" v-show="hasViewAuth('FirmAndProjectCategories',1)"
