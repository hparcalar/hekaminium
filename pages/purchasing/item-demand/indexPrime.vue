<template>
	<div id="sc-page-wrapper">
		<div id="sc-page-content">
			<ItemDemandPrime :record-id="demandId" :is-dialog="false" @onChange="onFormChange" @onSaved="onFormSaved" />
		</div>
	</div>
</template>
...
export default {
	...
	components: {
		ItemDemandPrime: process.client ? () => import('~/logical_components/ItemDemandPrime') : null,
	},
	data: () => ({
		demandId: 0,
		changeFlag: false,
