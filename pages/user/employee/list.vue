  ...
  export default {
    ...
    data: () => {
      return {
        visualData: [],
        dtColumns: [
          { data: "employeeCode", title: "Personel Kodu", visible: true, width:"15%" },
          { data: "employeeName", title: "Ad Soyad", visible: true, width:"15%" },
          { data: "employeeCardNo", title: "Kart Numarası", visible: true, width:"15%" },
          { data: "employeeHourlyWage", title: "Saatlik Ücret", visible: true, width:"15%" },
          { data: "employeePhone", title: "Telefon", visible: true, width:"15%" },
          { data: "employeeAddress", title: "Adres", visible: true, width:"25%" },
        ],
        dtDHeaders: [],
        dtDOptions: {
          select: true,
